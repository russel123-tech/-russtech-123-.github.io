...
<body class = "main">
		...
		<div class = "login">
			...
			<form action="adminreg.php" method="post">
				...
				<input type="text" name="username" id="username" class="form-control input_user" placeholder = "Admin Email" required>
				...
				<p>Not Registered?<a href = "adminreg.php" class = "Create">Create an account</a></p>
		...
		$('#login').click(function(e){
			...
			$.ajax({
				...
				success: function(data){
					alert(data);
					if($.trim(data) === "Welcome Admin!"){
						setTimeout(' window.location.href =  "admin_homepage.php"', 1000);
					}
				},
				error: function(data){
