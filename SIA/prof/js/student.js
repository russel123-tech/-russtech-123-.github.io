    ...
    $('#calendar').fullCalendar({
        ...
        dayClick: function(date, event, view) {
            ...
            /*({
                ...
                title: 'Add Examination Schedule (' + date.format() + ')' // Modal title
            });*/
        },
        // Event Mouseover
        eventMouseover: function(calEvent, jsEvent, view){
            var tooltip = '<div class="event-tooltip">' + calEvent.title + calEvent.description + '</div>';
            $("body").append(tooltip);
            $(this).mouseover(function(e) {
                $(this).css('z-index', 10000);
                $('.event-tooltip').fadeIn('5000');
                $('.event-tooltip').fadeTo('100', 1.9);
        ...
        eventClick: function(calEvent, jsEvent, view) {
            ...
            modal({
                ...
                title: 'New Event "' + calEvent.title + '"',
                event: calEvent
            });
        }
    });
